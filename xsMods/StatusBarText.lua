...
--[[	Only in TBC Classic (This module is disabled for that)
...
for parent,barlist in pairs(AnchorSettings) do
	for bar,anchorlist in pairs(barlist) do
		local tbl={};
...
local function VerifyStatusBar(bar)
	...
	if not tbl then return nil; end--	Not one of our bars (Also stops recursion)
